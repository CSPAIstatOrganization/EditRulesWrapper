 ...
 *       &lt;sequence>
 *         &lt;element ref="{ddi:physicaldataproduct_ncube_normal:3_1}Dimension" maxOccurs="unbounded"/>
 *         &lt;element ref="{ddi:physicaldataproduct_ncube_normal:3_1}Attribute" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{ddi:physicaldataproduct_ncube_normal:3_1}Measure" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class DataItemType {
    ...
    /**
     * Describes an attribute attached to the specified DataItem. The content of the attribute can be provided as a single value or as a reference to a location in the data storage where the attribute value will be found.Gets the value of the attribute property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
