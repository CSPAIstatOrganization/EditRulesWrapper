 ...
 *       &lt;sequence>
 *         &lt;element ref="{ddi:physicaldataproduct_ncube_normal:3_1}NCubeReference"/>
 *         &lt;element ref="{ddi:physicaldataproduct_ncube_normal:3_1}Attribute" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{ddi:physicaldataproduct_ncube_normal:3_1}DataItem" maxOccurs="unbounded"/>
    ...
    extends VersionableType
{
    ...
    /**
     * Identifies a physical storage location for an individual data entry, serving as a link between the physical location and the logical content description of each data item.Gets the value of the dataItem property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
