 ...
 * generated in the ddi.physicaldataproduct_ncube_inline._3_1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _RecordLayout_QNAME = new QName("ddi:physicaldataproduct_ncube_inline:3_1", "RecordLayout");
    private final static QName _Measure_QNAME = new QName("ddi:physicaldataproduct_ncube_inline:3_1", "Measure");
    private final static QName _NCubeInstance_QNAME = new QName("ddi:physicaldataproduct_ncube_inline:3_1", "NCubeInstance");
    private final static QName _MeasureReference_QNAME = new QName("ddi:physicaldataproduct_ncube_inline:3_1", "MeasureReference");
    private final static QName _VariableReference_QNAME = new QName("ddi:physicaldataproduct_ncube_inline:3_1", "VariableReference");
    private final static QName _NCubeReference_QNAME = new QName("ddi:physicaldataproduct_ncube_inline:3_1", "NCubeReference");
    private final static QName _Dimension_QNAME = new QName("ddi:physicaldataproduct_ncube_inline:3_1", "Dimension");
    private final static QName _AttributeReference_QNAME = new QName("ddi:physicaldataproduct_ncube_inline:3_1", "AttributeReference");
    private final static QName _Attribute_QNAME = new QName("ddi:physicaldataproduct_ncube_inline:3_1", "Attribute");
    private final static QName _DataItem_QNAME = new QName("ddi:physicaldataproduct_ncube_inline:3_1", "DataItem");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ddi.physicaldataproduct_ncube_inline._3_1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_inline:3_1", name = "RecordLayout", substitutionHeadNamespace = "ddi:physicaldataproduct:3_1", substitutionHeadName = "BaseRecordLayout")
     ...
     * 
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_inline:3_1", name = "Measure")
     ...
     * 
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_inline:3_1", name = "NCubeInstance")
     ...
     * 
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_inline:3_1", name = "MeasureReference")
     ...
     * 
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_inline:3_1", name = "VariableReference")
     ...
     * 
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_inline:3_1", name = "NCubeReference")
     ...
     * 
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_inline:3_1", name = "Dimension")
     ...
     * 
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_inline:3_1", name = "AttributeReference")
     ...
     * 
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_inline:3_1", name = "Attribute")
     ...
     * 
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_inline:3_1", name = "DataItem")
